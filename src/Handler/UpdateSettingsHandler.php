...
class UpdateSettingsHandler
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        ...
        //предполагаем, что у нас одна форма, и при попытке обновить код (юзер не успел) форма прилетает повторно
        //если нет, то добавляем еще одно поле expire, которое будем проверять и увеличиваем ttl
